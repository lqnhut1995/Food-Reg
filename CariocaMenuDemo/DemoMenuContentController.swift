...
class DemoMenuContentController: UITableViewController, CariocaDataSource {
	...
	var menuItems: [CariocaMenuItem] = [
        CariocaMenuItem("Welcome", .icon(UIImage(named: "setting")!)),
		CariocaMenuItem("Convolution Network", .icon(UIImage(named: "cnn")!)),
		CariocaMenuItem("Faster RCNN", .icon(UIImage(named: "fasterRCNN")!)),
		CariocaMenuItem("YOLO", .icon(UIImage(named: "yolo")!)),
	]
