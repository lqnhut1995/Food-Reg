...
extension MainViewController: CariocaDelegate {
	func cariocamenu(_ menu: CariocaMenu, didSelect item: CariocaMenuItem, at index: Int) {
		...
		switch index {
		case 1:
			displayDemo(DemoCNNViewController.fromStoryboard())
		case 2:
			displayDemo(DemoFasterRCNNViewController.fromStoryboard())
		case 3:
			displayDemo(DemoYOLOViewController.fromStoryboard())
		default:
			displayDemo(DemoHomeViewController.fromStoryboard())
		}
    }
